...
import com.exemplospring.course.entities.*;
import com.exemplospring.course.entities.enums.OrderStatus;
import com.exemplospring.course.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        o1.setPayment(pay1); // Como pay1 é obj dependente de Order, se chama o setPayment() atraves de o1 para instanciar pay1.
